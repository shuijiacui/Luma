  ...
  return (
    <div className="relative">
      <button
        ...
        className={cn(
          'group flex items-center rounded-2xl text-sm font-bold text-luma-teal-900 outline-none transition-transform hover:scale-105 focus-visible:ring-3 focus-visible:ring-luma-gold-300/60',
      ...
      >
        ...
        {!compact && (
          <span className="text-left leading-tight">
            <span className="block">我的头像</span>
