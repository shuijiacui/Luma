  ...
  return (
    <button type="button" className={`creation-door${opening ? ' is-open' : ''}`} onClick={onOpen} disabled={opening} aria-label={t(opening ? '正在打开创作大门' : '打开大门，去画画')}>
      ...
      <span className="door-leaf" aria-hidden="true">
        ...
        <span className="door-plaque-lettering"><svg viewBox="0 0 40 40" fill="none"><path d="m13 26 14-17 6 5-15 16-5-4Z" fill="#d3a550" stroke="#8d713e" strokeWidth="1.2" /><path d="m13 26-4 9 9-5" fill="#fff3cf" stroke="#8d713e" strokeWidth="1.2" /><path d="m9 35 2-5 3 3" fill="#517969" /></svg><strong>{t("去画画")}</strong></span>
      </span>
