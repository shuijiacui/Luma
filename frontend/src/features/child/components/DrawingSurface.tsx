...
export function DrawingSurface({ children, surfaceRef, document, onReady }: DrawingSurfaceProps) {
  ...
  useLayoutEffect(() => {
    ...
    function measure() {
      ...
      aspect.current ??= documentAspect(latestDocument.current)
  ...
  useLayoutEffect(() => { measureRef.current() }, [document])
  useLayoutEffect(() => {
